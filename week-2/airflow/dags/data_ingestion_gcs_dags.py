...
dataset_file = "yellow_tripdata_2020-01.csv"
dataset_url = f"https://s3.amazonaws.com/nyc-tlc/misc/{datset_file}"
path_to_local_home = os.environ.get("AIRFLOW_HOME", "/opt/airflow/")
parquet_file = dataset_file.replace('.csv', '.parquet')
BIGQUERY_DATASET = os.environ.get("BIGQUERYDATASET", 'trips_all')
...
with DAG(
    dag_id="data_ingestion_gcs_dags",
